...
class celeb_eyes(face_overlay_filter):
    def __init__(self,
                 eye_cascade,
                 smile_cascade,
                 face_cascade,
        ...
        self.friendly_name = 'Celeb Eyes'
        self.description = """Add random set of celeb eyes on detected eyes"""
        self.example_url = 'https://pbs.twimg.com/profile_images/1097653728189050883/1hxWOyei_400x400.jpg'
        self.randomization = ['eyes chosen']
        curr_dir = os.path.dirname(os.path.abspath(__file__))
        self.additives = os.path.join(curr_dir, 'celeb_eyes')
    ...
    def filter_image(self, input, coords=None):
        ...
        eyes_chosen = random.choice(os.listdir(self.additives))
        overlay = cv2.imread(self.additives + '/' + eyes_chosen, -1)
...
if __name__ == '__main__':
    ...
    filterClass = celeb_eyes(eye_cascade,
                             smile_cascade,
                             face_cascade,
                             mode='eyes',
                             debug=True)
